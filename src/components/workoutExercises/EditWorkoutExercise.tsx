...
import { EntityTypes, IWorkout, IWorkoutExercise } from '@shared/types/types';
...
const EditWorkoutExercise: React.FC<EditWorkoutExerciseProps> = ({ getEntityById, loading }) => {
	...
	return <EditEntity pEntity={entity} pEntityName={EntityTypes.WorkoutExercise}  onSave={handleSave} onDelete={handleDelete} onCancel={handleCancel} />;
};

export default withEntityData<IWorkoutExercise>(EntityTypes.Workout)(EditWorkoutExercise);
